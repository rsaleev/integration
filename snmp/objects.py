...
class SNMPObject:
    ...
    def __init__(self,  codename: str, oid: str, enum_obj):
        super(SNMPObject, self).__init__
    ...
    @property
    def get(self):
        return {'device_id': self.device_id, 'device_type': self.device_type, 'codename': self.codename, 'value': self.snmpvalue, 'ts': self.ts}
...
receiving_mibs = [
    ...
    SNMPObject('OpenedUpperDoor', '.1.3.6.1.4.1.40383.1.2.2.21', None).instance,
    ...
    SNMPObject('BarrierLoop1Status', '.1.3.6.1.4.1.40383.1.2.2.113', None).instance,
...
polling_mibs = [
    ...
    SNMPObject('UpperDoor', '.1.3.6.1.4.1.40383.1.2.2.21', UppperDoorOpened).instance,
