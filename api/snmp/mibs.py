...
receiving_mibs = [
    ...
    SNMPObject('FiscalPrinterPaper', '.1.3.6.1.4.1.40383.1.2.1.10004.2.7', forced_value='OUT_OF_PAPER').instance,
    ...
    SNMPObject('FiscalPrinterPaper', '.1.3.6.1.4.1.40383.1.2.1.11003.2.2', forced_value='ALMOST_OUT_OF_PAPER').instance,
...
polling_mibs = [
    ...
    SNMPObject('SmartPayout', '.1.3.6.1.4.1.40383.1.2.1.42101.1', status_map=NotesEscrow).instance,
